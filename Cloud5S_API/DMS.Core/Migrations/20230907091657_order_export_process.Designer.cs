...
namespace DMS.CORE.Migrations
{
    ...
    [Migration("20230907091657_order_export_process")]
    partial class order_export_process
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DMS.CORE.Common.SQ._tblSequenceIncomeBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("_tblSequenceIncomeBill");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Common.SQ._tblSequencePayBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.tblAdSystemParameter", b =>
                {
                    ...
                    b.Property<string>("DefaultCementCode")
                        .HasColumnType("varchar(50)");

                    b.Property<string>("DefaultStockCode")
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuIncomeBill", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("varchar(50)");
                    ...
                    b.ToTable("tblBuIncomeBill");
                });

            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuIncomeBillOrderExport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IncomeBillCode")
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasIndex("IncomeBillCode");

                    b.ToTable("tblBuIncomeBillOrderExport");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuPayBill", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("varchar(50)");
                    ...
                    b.ToTable("tblBuPayBill");
                });

            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuPayBillOrderImport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PayBillCode");

                    b.ToTable("tblBuPayBillOrderImport");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblMdTracking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.tblMdBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.tblMdIncomeType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.tblMdPayType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.tblMdPricePolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("tblMdPricePolicy");
                });

            modelBuilder.Entity("DMS.CORE.Entities.MD.tblMdPurchasingStation", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("varchar(50)");
                    ...
                    b.ToTable("tblMdPurchasingStation");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoExport", b =>
                {
                    ...
                    b.Property<double?>("Debt")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("SumMoney - PayMoney");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoExportDetail", b =>
                {
                    ...
                    b.Property<double?>("SumMoney")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("Number * Price");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoExportProcess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("tblSoExportProcess");
                });

            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoImport", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("varchar(50)");
                    ...
                    b.ToTable("tblSoImport");
                });

            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoImportDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoOrderDetail", b =>
                {
                    ...
                    b.Property<double?>("SumMoney")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("ReleaseNumber*Price");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoScale", b =>
                {
                    ...
                    b.Property<double?>("ItemMoney")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("ItemPrice * ItemNumber");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuIncomeBill", b =>
                {
                    b.HasOne("DMS.CORE.Entities.MD.tblMdBankAccount", "BankAccount")
                    ...
                    b.HasOne("DMS.CORE.Entities.MD.tblMdIncomeType", "IncomeType")
                        .WithMany()
                        .HasForeignKey("Type");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuIncomeBillOrderExport", b =>
                {
                    b.HasOne("DMS.CORE.Entities.SO.tblSoExport", "OrderExport")
                        .WithMany("IncomeBillExports")
                        .HasForeignKey("ExportCode");

                    b.HasOne("DMS.CORE.Entities.BU.tblBuIncomeBill", "IncomeBill")
                        .WithMany("IncomeBillExports")
                        .HasForeignKey("IncomeBillCode");

                    b.Navigation("IncomeBill");

                    b.Navigation("OrderExport");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuPayBill", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.MD.tblMdPayType", "PayType")
                        .WithMany()
                        .HasForeignKey("Type");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuPayBillOrderImport", b =>
                {
                    b.HasOne("DMS.CORE.Entities.SO.tblSoImport", "OrderImport")
                        .WithMany("PayBillImports")
                        .HasForeignKey("ImportCode");

                    b.HasOne("DMS.CORE.Entities.BU.tblBuPayBill", "PayBill")
                        .WithMany("PayBillImports")
                        .HasForeignKey("PayBillCode");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuStockImport", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.SO.tblSoImport", "Import")
                        .WithMany()
                        .HasForeignKey("ImportCode");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoExport", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.MD.tblMdPurchasingStation", "Station")
                        .WithMany()
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoOrder", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.MD.tblMdPartner", "Company")
                        .WithMany()
                    ...
                    b.HasOne("DMS.CORE.Entities.MD.tblMdPurchasingStation", "PurchasingStation")
                        .WithMany()
                        .HasForeignKey("StationCode");
                    ...
                    b.Navigation("PurchasingStation");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuIncomeBill", b =>
                {
                    b.Navigation("IncomeBillExports");
                });
