...
namespace DMS.CORE.Migrations
{
    ...
    [Migration("20240125073937_update_import_export_orderstock")]
    partial class update_import_export_orderstock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuManufacture", b =>
                {
                    ...
                    b.Property<string>("OrderCodeFromStock")
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuManufacture", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.SO.tblSoOrder", "OrderFromStock")
                        .WithMany("ManufactureStocks")
                        .HasForeignKey("OrderCodeFromStock");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoOrder", b =>
                {
                    ...
                    b.Navigation("ManufactureStocks");
