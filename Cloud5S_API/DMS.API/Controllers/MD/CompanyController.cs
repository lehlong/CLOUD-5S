...
namespace DMS.API.Controllers.MD
{
    ...
    {
        public readonly ICompanyService _service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblCompanyCreateDto Company)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblCompanyDto Company)
        {
            var transferObject = new TransferObject();
        ...
        public async Task<IActionResult> Export([FromQuery] BaseExportFilter filter)
        {
            ...
            if (_service.Status)
            {
                return File(result, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "DSTRamVT" + DateTime.Now.ToString() + ".xlsx");
            }
            else
            {
                transferObject.Status = false;
