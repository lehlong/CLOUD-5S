...
@Component({
  selector: 'app-order-choose-item',
  templateUrl: './order-choose-item.component.html',
  styleUrls: ['./order-choose-item.component.scss']
})
export class OrderChooseItemComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<OrderChooseItemComponent>,
  ...
  selectTypeCode(e: any) {
    this.filter.TypeCode = e.target.value;
    this.search();
  }
