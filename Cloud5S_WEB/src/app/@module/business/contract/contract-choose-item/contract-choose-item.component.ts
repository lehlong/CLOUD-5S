...
@Component({
  selector: 'app-contract-choose-item',
  templateUrl: './contract-choose-item.component.html',
  styleUrls: ['./contract-choose-item.component.scss'],
})
export class ContractChooseItemComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ContractChooseItemComponent>,
